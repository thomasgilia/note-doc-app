...
//   return (
//     <HomepageLayout clients={...data.postgres.allClients.nodes} />)
    
//       // console.log(data) 
//       // data.postgres.allClients.nodes.map((c, index) => {
      // return (<HomepageLayout clients={c.clientName} />)
    // }
}
